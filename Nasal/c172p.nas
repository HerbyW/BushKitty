...
##########################################
# Brakes  /sim/model/c172p/brake-parking for use with the normal key
...
StaticModel.new("coneR", "Aircraft/BushKitty/Models/Exterior/safety-cone/safety-cone_R.xml");
StaticModel.new("coneL", "Aircraft/BushKitty/Models/Exterior/safety-cone/safety-cone_L.xml");
StaticModel.new("gpu", "Aircraft/BushKitty/Models/Exterior/external-power/external-power.xml");
StaticModel.new("ladder", "Aircraft/BushKitty/Models/Exterior/ladder/ladder.xml");
StaticModel.new("fueltanktrailer", "Aircraft/BushKitty/Models/Exterior/fueltanktrailer/fueltanktrailer.ac");
StaticModel.new("externalheater", "Aircraft/BushKitty/Models/Exterior/external-heater/RedDragonEnginePreHeater.ac");

# Mooring anchor and rope
StaticModel.new("anchorbuoy", "Aircraft/BushKitty/Models/Effects/pontoon/mooring.xml");
...
var cabin_temp_timer = maketimer(30000.0, log_cabin_temp);
